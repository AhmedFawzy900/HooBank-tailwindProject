...
const  Tesrimorials = () => {
  return (
    ...
    ${styles.flexCenter} flex-col relative`}> 
     ...
     rounded-full blue__gradient right-0'/>
     ...
     mb-6 relative z-[1]'>
      ...
      <div className='w-full md:mt-0 mt-6'>
       ...
       text-left max-w-[450px] text-[#999]`}>Everything you need to accept card payments and grow your business anywhere on the planet.</p>
      </div>
     </div>
