...
const Hero = () =>(
    ...
    md:flex-row flex-col ${styles.paddingY}`}>
        ...
        flex-col xl:px-0 sm:px-16 px-6`}>
          ...
          bg-discount-gradient rounded-[10px] md-2'>
            <img src={discount} alt="discount" 
            className='w-[32px] h-[32px]' /> 
              <p className={`${styles.paragraph} text-[#888] ml-2`}>
          ...
          <div className="ss:flex md:flex hidden  md:mr-4 mr-0">
            <GetStarted />
          </div>
        </div>
      ...
      <div className={`ss:hidden md:hidden ${styles.flexCenter}`}>
        <GetStarted />
      </div>
    </section>
  )
