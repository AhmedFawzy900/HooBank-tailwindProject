...
const FeedbackCard = ({content,name,title,img}) => {
  return (
    ...
    py-12 rounded-[20px] max-w-[370px]
    md:mr-10 sm:mr-5 mr-0 my-5 feedback-card'>
      <img src={quotes} alt="quots" className='w-[42px]
      h-[27px] object-contain' />
      ...
      <div className='flex flex-row'>
        ...
        <div className='flex flex-col ml-4'>
          ...
          text-[20px] leading-[32px] text-white">{name}</h4>
          <p className="font-poppins font-semibold 
          text-[16px] leading-[24px] text-[#999]">{title}</p>
